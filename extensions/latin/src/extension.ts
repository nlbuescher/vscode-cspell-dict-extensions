...
export function activate(context: vscode.ExtensionContext) {
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('cSpellExt_latin.enable', () => enable(true)),
        vscode.commands.registerCommand('cSpellExt_latin.disable', () => disable(true)),
        vscode.commands.registerCommand('cSpellExt_latin.enableWorkspace', () => enable(false)),
        vscode.commands.registerCommand('cSpellExt_latin.disableWorkspace', () => disable(false)),
    );
    // 
}
